...
$S0_STATUS--proxy.socket -p ActiveState | grep -v inactive | grep active
$S0_STATUS--proxy -p ActiveState | grep inactive
...
$S0_STATUS--proxy -p ActiveState | grep -v inactive | grep active
...
$S1_STATUS--proxy.socket -p ActiveState | grep -v inactive | grep active
$S1_STATUS--proxy -p ActiveState | grep inactive
...
$S1_STATUS--proxy -p ActiveState | grep -v inactive | grep active
...
$S2_STATUS--proxy.socket -p ActiveState | grep -v inactive | grep active
$S2_STATUS--proxy -p ActiveState | grep inactive
...
$S2_STATUS--proxy -p ActiveState | grep -v inactive | grep active
...
$S3_STATUS--proxy.socket -p ActiveState | grep -v inactive | grep active
$S3_STATUS--proxy -p ActiveState | grep inactive
...
$S3_STATUS--proxy -p ActiveState | grep -v inactive | grep active
...
$S4_STATUS--proxy.socket -p ActiveState | grep -v inactive | grep active
$S4_STATUS--proxy -p ActiveState | grep inactive
...
$S4_STATUS--proxy -p ActiveState | grep -v inactive | grep active
# $S4_STATUS -p ActiveState | grep -v inactive | grep active

## http socket for service5 is setup and listening
$S5_STATUS--proxy.socket -p ActiveState | grep -v inactive | grep active
$S5_STATUS--proxy -p ActiveState | grep inactive
...
$S5_STATUS--proxy -p ActiveState | grep -v inactive | grep active
